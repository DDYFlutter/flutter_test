...
//    testCascade();
  ...
  testType() {
    ...
    var newObjectNum1 = objectNum.toString(); // 强制类型转换，转String
    print(newObjectNum1.length); // 此时为String,可调用length
    var newObjectNum2 = int.parse(newObjectNum1); // 强制类型转换，转int
    print(newObjectNum2); // 此时为int
  ...
  testStrings() {
    ...
    print(nickName + address + profile + formatStr);
